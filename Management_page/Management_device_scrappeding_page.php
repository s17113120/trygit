            ...
            <ul class="navbar-nav mr-auto">
                ...
                <div class="dropdown" onmouseover="document.getElementById('deviceDropDownMeun').style.display = 'block';" onmouseout="document.getElementById('deviceDropDownMeun').style.display = 'none';">
                    ...
                    <div class="dropdown-menu" id="deviceDropDownMeun" aria-labelledby="deviceMenuButton" style="background-color: rgba(255, 202, 229, 0.9); display: none;" onmouseout="document.getElementById('deviceDropDownMeun').style.display = 'none';">
                        ...
                        <a class="dropdown-item active" href="../Management_page/Management_device_scrappeding_page.php">報廢中</a>
        ...
        <div class="row mt-3">
            <div class="col">
                <div class="alert alert-warning" style="width:180px" role="alert">
                    <i class="fas fa-arrow-alt-circle-down"></i>　設備報廢中
                </div>
            </div>
            <div class="col">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select updatecheck" id="deviceUpdateStatus" onchange="checkvalueFun(this)">
                            ...
                            <option selected value="2">報廢中</option>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        function showDeviceScrappedingTable(){
            $.ajax({
                url: '../Management_all_api/Management_device_scrappeding_api.php',
                method: 'post',
                dataType: 'json',
                data: {
                ...
                if (allDamageData.length > 0) {
                    ...
                    for (let i=0 ; i<allDamageData.length ; i++) {
                        ...
                        `<tr data-id="${allDamageData[i].D_Id}" data-page="${Math.ceil((i+1)/onePageHowData)}">
                            ...
                            <td data-type="D_Lend">
                                ${(allDamageData[i].D_Status == 2 ? "報廢中" : "怪怪的")}
                            </td>
                        </tr>`;
                    }
                    ...
                    if (searchData.length > 0) {
                        for (let i=0 ; i<searchData.length ; i++) {
                            searchDataStr +=
                                ...
                                <td data-type="D_Lend">
                                    ${(searchData[i].D_Status == 2 ? "報廢中" : "怪怪的")}
                                </td>
                            </tr>`;
                        }
